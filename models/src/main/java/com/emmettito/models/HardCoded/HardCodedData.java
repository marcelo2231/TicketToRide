...
public class HardCodedData {
    ...
    public List<Route> getRoutes() {
        ...
        routes.add(new Route(0, new Tuple(0, 1), spaces, -1, null));
        ...
        routes.add(new Route(1, new Tuple(1, 2), spaces, -1, TrainColor.White));
        ...
        routes.add(new Route(2, new Tuple(2, 3), spaces, -1, null));
        ...
        routes.add(new Route(3, new Tuple(3, 4), spaces, -1, TrainColor.Black));
        ...
        routes.add(new Route(4, new Tuple(4, 5), spaces, 5, null));
        ...
        routes.add(new Route(5, new Tuple(4, 5), spaces, 4, null));
        ...
        routes.add(new Route(6, new Tuple(4, 21), spaces, -1, null));
        ...
        routes.add(new Route(7, new Tuple(3, 21), spaces, -1, null));
        ...
        routes.add(new Route(8, new Tuple(3, 20), spaces, -1, null));
        ...
        routes.add(new Route(9, new Tuple(2, 20), spaces, -1, TrainColor.Black));
        ...
        routes.add(new Route(10, new Tuple(2, 19), spaces, -1, TrainColor.Blue));
        ...
        routes.add(new Route(11, new Tuple(1, 19), spaces, -1, null));
        ...
        routes.add(new Route(17, new Tuple(18, 19), spaces, -1, TrainColor.Yellow));
        ...
        routes.add(new Route(18, new Tuple(19, 20), spaces, -1, TrainColor.Orange));
        ...
        routes.add(new Route(19, new Tuple(20, 21), spaces, -1, TrainColor.Pink));
        ...
        routes.add(new Route(20, new Tuple(4, 6), spaces, -1, TrainColor.Blue));
        ...
        routes.add(new Route(21, new Tuple(5, 6), spaces, 22, TrainColor.Yellow));
        ...
        routes.add(new Route(22, new Tuple(5, 6), spaces, 21, TrainColor.Red));
        ...
        routes.add(new Route(23, new Tuple(19, 32), spaces, -1, TrainColor.Red));
        ...
        routes.add(new Route(24, new Tuple(19, 32), spaces, -1, TrainColor.Green));
        ...
        routes.add(new Route(25, new Tuple(19, 30), spaces, -1, TrainColor.Pink));
        ...
        routes.add(new Route(26, new Tuple(20, 32), spaces, 27, null));
        ...
        routes.add(new Route(27, new Tuple(20, 32), spaces, 26, null));
        ...
        routes.add(new Route(28, new Tuple(20, 33), spaces, -1, TrainColor.Red));
        ...
        routes.add(new Route(29, new Tuple(21, 33), spaces, -1, TrainColor.White));
        ...
        routes.add(new Route(30, new Tuple(21, 22), spaces, -1, null));
        ...
        routes.add(new Route(31, new Tuple(22, 33), spaces, 32, TrainColor.Orange));
        ...
        routes.add(new Route(32, new Tuple(22, 33), spaces, 31, TrainColor.Black));
        ...
        routes.add(new Route(33, new Tuple(32, 33), spaces, -1, TrainColor.Blue));
        ...
        routes.add(new Route(34, new Tuple(6, 22), spaces, 35, TrainColor.White));
        ...
        routes.add(new Route(35, new Tuple(6, 22), spaces, 34, TrainColor.Green));
        ...
        routes.add(new Route(36, new Tuple(6, 7), spaces, 37, TrainColor.Orange));
        ...
        routes.add(new Route(37, new Tuple(6, 7), spaces, 36, TrainColor.Black));
        ...
        routes.add(new Route(38, new Tuple(7, 22), spaces, -1, null));
        ...
        routes.add(new Route(39, new Tuple(7, 8), spaces, 40, null));
        ...
        routes.add(new Route(40, new Tuple(7, 8), spaces, 39, null));
        ...
        routes.add(new Route(41, new Tuple(8, 25), spaces, -1, TrainColor.Black));
        ...
        routes.add(new Route(42, new Tuple(8, 22), spaces, -1, null));
        ...
        routes.add(new Route(43, new Tuple(22, 35), spaces, -1, TrainColor.Green));
        ...
        routes.add(new Route(44, new Tuple(22, 25), spaces, -1, TrainColor.Yellow));
        ...
        routes.add(new Route(45, new Tuple(8, 9), spaces, -1, null));
        ...
        routes.add(new Route(46, new Tuple(8, 23), spaces, 47, null));
        ...
        routes.add(new Route(47, new Tuple(8, 23), spaces, 46, null));
        ...
        routes.add(new Route(48, new Tuple(33, 35), spaces, 49, TrainColor.Green));
        ...
        routes.add(new Route(49, new Tuple(33, 35), spaces, 48, TrainColor.White));
        ...
        routes.add(new Route(50, new Tuple(34, 35), spaces, 51, TrainColor.Blue));
        ...
        routes.add(new Route(51, new Tuple(34, 35), spaces, 50, TrainColor.Pink));

        // Route 52: Omaha 32 - Kansas City 34
        spaces = new ArrayList<>();
        spaces.add(new Space(0.5431539f, 0.5086644f, 62.5f));
        routes.add(new Route(52, new Tuple(32, 34), spaces, 53, null));

        // Route 53: Omaha 32 - Kansas City 34
        spaces = new ArrayList<>();
        spaces.add(new Space(0.55640244f, 0.499287f, 62.5f));
        routes.add(new Route(53, new Tuple(32, 34), spaces, 52, null));
        ...
        routes.add(new Route(54, new Tuple(31, 32), spaces, -1, TrainColor.Pink));
        ...
        routes.add(new Route(55, new Tuple(31, 34), spaces, 56, TrainColor.Black));
        ...
        routes.add(new Route(56, new Tuple(31, 34), spaces, 55, TrainColor.Orange));
        ...
        routes.add(new Route(57, new Tuple(30, 31), spaces, 58, TrainColor.Red));
        ...
        routes.add(new Route(58, new Tuple(30, 31), spaces, 57, TrainColor.Yellow));
        ...
        routes.add(new Route(59, new Tuple(17, 30), spaces, -1, TrainColor.Blue));
        ...
        routes.add(new Route(60, new Tuple(16, 17), spaces, 61, TrainColor.Green));
        ...
        routes.add(new Route(61, new Tuple(16, 17), spaces, 60, TrainColor.Pink));
        ...
        routes.add(new Route(62, new Tuple(16, 30), spaces, 63, TrainColor.Orange));
        ...
        routes.add(new Route(63, new Tuple(16, 30), spaces, 62, TrainColor.White));
        ...
        routes.add(new Route(64, new Tuple(15, 16), spaces, 65, TrainColor.Yellow));
        ...
        routes.add(new Route(65, new Tuple(15, 16), spaces, 64, TrainColor.Pink));
        ...
        routes.add(new Route(66, new Tuple(15, 29), spaces, -1, null));
        ...
        routes.add(new Route(67, new Tuple(29, 30), spaces, -1, TrainColor.Orange));
        ...
        routes.add(new Route(68, new Tuple(14, 15), spaces, -1, null));
        ...
        routes.add(new Route(69, new Tuple(13, 15), spaces, -1, TrainColor.Black));
        ...
        routes.add(new Route(70, new Tuple(13, 14), spaces, -1, null));
        ...
        routes.add(new Route(71, new Tuple(14, 31), spaces, -1, TrainColor.White));
        ...
        routes.add(new Route(72, new Tuple(14, 28), spaces, -1, null));
        ...
        routes.add(new Route(73, new Tuple(13, 28), spaces, -1, null));
        ...
        routes.add(new Route(74, new Tuple(28, 31), spaces, -1, null));
        ...
        routes.add(new Route(75, new Tuple(27, 28), spaces, -1, TrainColor.Blue));
        ...
        routes.add(new Route(76, new Tuple(27, 31), spaces, -1, TrainColor.Red));
        ...
        routes.add(new Route(77, new Tuple(13, 27), spaces, -1, TrainColor.Yellow));
        ...
        routes.add(new Route(78, new Tuple(12, 13), spaces, -1, TrainColor.Green));
        ...
        routes.add(new Route(79, new Tuple(13, 26), spaces, -1, TrainColor.Red));

        // Route 80: Houston 12 - Dallas 26
        spaces = new ArrayList<>();
        spaces.add(new Space(0.57455355f, 0.901304f, 50.0f));
        routes.add(new Route(80, new Tuple(12, 26), spaces, 81, null));

        // Route 81: Houston 12 - Dallas 26
        spaces = new ArrayList<>();
        spaces.add(new Space(0.58498746f, 0.8848894f, 47.5f));
        routes.add(new Route(81, new Tuple(12, 26), spaces, 80, null));
        ...
        routes.add(new Route(82, new Tuple(26, 27), spaces, 83, null));
        ...
        routes.add(new Route(83, new Tuple(26, 27), spaces, 82, null));
        ...
        routes.add(new Route(84, new Tuple(27, 34), spaces, 85, null));
        ...
        routes.add(new Route(85, new Tuple(27, 34), spaces, 84, null));
        ...
        routes.add(new Route(86, new Tuple(24, 27), spaces, -1, null));
        ...
        routes.add(new Route(87, new Tuple(24, 26), spaces, -1, null));
        ...
        routes.add(new Route(88, new Tuple(24, 35), spaces, -1, null));
        ...
        routes.add(new Route(89, new Tuple(11, 12), spaces, -1, null));
        ...
        routes.add(new Route(90, new Tuple(25, 35), spaces, -1, null));
        ...
        routes.add(new Route(91, new Tuple(11, 24), spaces, -1, TrainColor.Green));
        ...
        routes.add(new Route(92, new Tuple(24, 25), spaces, -1, TrainColor.White));

        // Route 93: Atlanta 23 - Nashville 25
        spaces = new ArrayList<>();
        spaces.add(new Space(0.77535385f, 0.65048295f, 35.0f));
        routes.add(new Route(93, new Tuple(23, 25), spaces, -1, null));
        ...
        routes.add(new Route(94, new Tuple(11, 23), spaces, 95, TrainColor.Yellow));
        ...
        routes.add(new Route(95, new Tuple(11, 23), spaces, 94, TrainColor.Orange));
        ...
        routes.add(new Route(96, new Tuple(9, 23), spaces, -1, null));
        ...
        routes.add(new Route(97, new Tuple(10, 11), spaces, -1, TrainColor.Red));
        ...
        routes.add(new Route(98, new Tuple(10, 23), spaces, -1, TrainColor.Blue));
        ...
        routes.add(new Route(99, new Tuple(9, 10), spaces, -1, TrainColor.Pink));
